...
public class Entertainment extends AppCompatActivity {
    ...
    private final String url = "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=43a3a6d4d9204f8886265212e5cc2f97";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycle_entertainment);
